...
exports.getUserFromToken = exports.refreshAccessToken = exports.Authorize = exports.Authenticate = void 0;
...
const refreshAccessToken = async (req, res) => {
    ...
    try {
        ...
        jsonwebtoken_1.default.verify(refresh_token, process.env.TOKEN_REFRESH_KEY);
